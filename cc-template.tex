\documentclass[table,xcdraw,11pt,a4paper]{scrartcl}  
...
\rfoot{\tiny{Seite \thepage\ von \pageref*{LastPage}\\
          $if(date)$Datum: $date$\\$endif$
          $if(version)$Vers. $version$$endif$}}
...
\begin{center}
\includegraphics[width=0.6\textwidth]{logo-wbh.jpg}
\end{center}
}
...
\begin{titlingpage}
    ...
    \begin{center}
    \includegraphics[width=.8\textwidth]{logo-wbh.jpg}
    \end{center}
